...
Para documentação detalhada sobre funcionalidades específicas, consulte a pasta [`wiki/`](./wiki/):

### 🚀 **Funcionalidades Principais**
- [**Configurable Payload Feature**](./wiki/CONFIGURABLE_PAYLOAD_FEATURE.md) - Payloads configuráveis para Lambda
- [**Hierarchical Payload Feature**](./wiki/HIERARCHICAL_PAYLOAD_FEATURE.md) - Estruturas JSON aninhadas com suporte a `lambda.body`

### 🔐 **Autenticação e IRSA**
- [**IRSA Validation Guide**](./wiki/IRSA_VALIDATION_GUIDE.md) - Guia completo para validação de IRSA
- [**IRSA Provider Comparison**](./wiki/IRSA_PROVIDER_COMPARISON.md) - Comparação de provedores de credenciais
- [**IRSA Priority Analysis**](./wiki/IRSA_PRIORITY_ANALYSIS.md) - Análise de prioridade de credenciais

### 🛠️ **Desenvolvimento e Scripts**
- [**Scripts Reference**](./wiki/SCRIPTS_REFERENCE.md) - Referência de scripts disponíveis
- [**AWS Lambda Groovy Documentation**](./wiki/AWS_LAMBDA_GROOVY_DOCUMENTATION.md) - Documentação de scripts Groovy
- [**README PowerShell**](./wiki/README_POWERSHELL.md) - Scripts PowerShell para validação

### 📦 **Release e Versionamento**
- [**Release Guide**](./wiki/RELEASE_GUIDE.md) - Guia para releases
- [**Automatic Release System**](./wiki/AUTOMATIC_RELEASE_SYSTEM.md) - Sistema automático de releases
- [**Semantic Versioning**](./wiki/SEMANTIC_VERSIONING.md) - Guia de versionamento semântico

### 📖 **Documentação Geral**
- [**README Principal**](./wiki/README.md) - Documentação completa do projeto
- [**AWS README**](./wiki/aws-README.md) - Documentação específica da pasta AWS
